...
namespace CSADataReport.DAL
{
	...
	public partial class LinerIncomeDatas
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "T_LinerIncomeDatas"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from T_LinerIncomeDatas");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(CSADataReport.Model.LinerIncomeDatas model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_LinerIncomeDatas(");
			strSql.Append("CompanyId,ReportWeek,ReportYear,LinerCompanyId,ProxyShipIncome,DocumentIncome,IsReported,AddTime,EditTime)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ProxyShipIncome", SqlDbType.Decimal,13),
					new SqlParameter("@DocumentIncome", SqlDbType.Decimal,13),
			...
			parameters[4].Value = model.ProxyShipIncome;
			parameters[5].Value = model.DocumentIncome;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(CSADataReport.Model.LinerIncomeDatas model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_LinerIncomeDatas set ");
			strSql.Append("CompanyId=@CompanyId,");
			strSql.Append("ReportWeek=@ReportWeek,");
			strSql.Append("ReportYear=@ReportYear,");
			strSql.Append("LinerCompanyId=@LinerCompanyId,");
			strSql.Append("ProxyShipIncome=@ProxyShipIncome,");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_LinerIncomeDatas ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CSADataReport.Model.LinerIncomeDatas GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,CompanyId,ReportWeek,ReportYear,LinerCompanyId,ProxyShipIncome,DocumentIncome,IsReported,AddTime,EditTime from T_LinerIncomeDatas ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CSADataReport.Model.LinerIncomeDatas DataRowToModel(DataRow row)
		{
			CSADataReport.Model.LinerIncomeDatas model=new CSADataReport.Model.LinerIncomeDatas();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,CompanyId,ReportWeek,ReportYear,LinerCompanyId,ProxyShipIncome,DocumentIncome,IsReported,AddTime,EditTime ");
			strSql.Append(" FROM T_LinerIncomeDatas ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,CompanyId,ReportWeek,ReportYear,LinerCompanyId,ProxyShipIncome,DocumentIncome,IsReported,AddTime,EditTime ");
			strSql.Append(" FROM T_LinerIncomeDatas ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_LinerIncomeDatas T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_LinerIncomeDatas";
