<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinerDatasManage.aspx.cs" Inherits="CSADataReport.Web.Admin.LinerDatasManage" %>
...
<body id="tBody">
    ...
    <div align="center">
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DeleteByModel" 
            SelectMethod="GetModelListEx" TypeName="CSADataReport.BLL.LinerDatas" 
            OldValuesParameterFormatString="original_{0}" 
            DataObjectTypeName="CSADataReport.Model.LinerDatas" InsertMethod="Add" 
            UpdateMethod="Update">
            <SelectParameters>
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="ObjectDataSource1" 
            ...
            <AlternatingItemTemplate>
                <tr align="center" style="background-color: #FFFFFF;color: #284775;">
                    ...
                    <td>
                        <asp:Label ID="ProxyShipCountLabel" runat="server" 
                            Text='<%# Eval("ProxyShipCount") %>' />
                    </td>
                    <td>
                        <asp:Label ID="ProxyContainerCountLabel" runat="server" 
                            Text='<%# Eval("ProxyContainerCount") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr align="center" style="background-color: #999999;">
                    ...
                    <td>
                        <asp:TextBox ID="ProxyShipCountTextBox" runat="server" 
                            Text='<%# Bind("ProxyShipCount") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="ProxyContainerCountTextBox" runat="server" 
                            Text='<%# Bind("ProxyContainerCount") %>' />
                    </td>
                    <td>
                        <asp:CheckBox ID="IsReportedCheckBox" runat="server" 
                    ...
                    <tr runat="server">
                        <td runat="server">
                            <table ID="itemPlaceholderContainer" runat="server" border="1" 
                                ...
                                <tr align="center" runat="server" style="background-color: #E0FFFF;color: #333333;">
                                    <th runat="server">
                                    </th>
