<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinerIncomeDatas.aspx.cs" Inherits="CSADataReport.Web.LinerIncomeDatas" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>班轮收入填报(月报)</title>
...
<div>
<h2 align="center">班轮收入数据填报(月报)</h2>
</div>
    ...
    <center>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
         OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="船代收入">
                <ItemTemplate>
                    <asp:TextBox ID="x2" style="text-align:right" runat="server" ></asp:TextBox>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="单证收入">
                <ItemTemplate>
                    <asp:TextBox ID="x3" style="text-align:right" runat="server" ></asp:TextBox>
                </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        ...
        <asp:Label ID="lblShipIncomeTotal" runat="server" Text="" Width="150px"></asp:Label>
        <asp:Label ID="lblDocumentIncomeTotal" runat="server" Text="" Width="150px"></asp:Label> 
    <table>
        <tr>
            <td></td>
            <td>
