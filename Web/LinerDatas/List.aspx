<%@ Page Title="T_LinerDatas" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CSADataReport.Web.LinerDatas.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ProxyShipCount" HeaderText="ProxyShipCount" SortExpression="ProxyShipCount" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ProxyContainerCount" HeaderText="ProxyContainerCount" SortExpression="ProxyContainerCount" ItemStyle-HorizontalAlign="Center"  /> 
