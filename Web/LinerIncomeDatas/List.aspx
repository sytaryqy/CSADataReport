<%@ Page Title="T_LinerIncomeDatas" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CSADataReport.Web.LinerIncomeDatas.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="LinerCompanyId" HeaderText="LinerCompanyId" SortExpression="LinerCompanyId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ProxyShipIncome" HeaderText="ProxyShipIncome" SortExpression="ProxyShipIncome" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="DocumentIncome" HeaderText="DocumentIncome" SortExpression="DocumentIncome" ItemStyle-HorizontalAlign="Center"  /> 
