<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinerIncomeDatasList.aspx.cs" Inherits="CSADataReport.Web.LinerIncomeDatasList" %>
...
<body>
<h3 align="center">班轮收入已上报数据</h3>
    <form id="form1" runat="server">
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="GetModelListByCompanyId" 
        TypeName="CSADataReport.BLL.LinerIncomeDatas">
        <SelectParameters>
    ...
    <center>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ProxyShipIncome" HeaderText="船代收入" 
                    SortExpression="ProxyShipIncome" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="DocumentIncome" 
                    HeaderText="单证收入" SortExpression="DocumentIncome" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
