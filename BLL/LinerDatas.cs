...
namespace CSADataReport.BLL
{
	...
	{
		private readonly CSADataReport.DAL.LinerDatas dal=new CSADataReport.DAL.LinerDatas();
		public LinerDatas()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CSADataReport.Model.LinerDatas GetModelByCache(int Id)
		{
			
			string CacheKey = "LinerDatasModel-" + Id;
			...
			return (CSADataReport.Model.LinerDatas)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CSADataReport.Model.LinerDatas> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CSADataReport.Model.LinerDatas> DataTableToList(DataTable dt)
		{
