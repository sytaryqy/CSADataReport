...
namespace CSADataReport.BLL
{
	...
	{
		private readonly CSADataReport.DAL.Users dal=new CSADataReport.DAL.Users();
		public Users()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CSADataReport.Model.Users GetModelByCache(int Id)
		{
			...
			return (CSADataReport.Model.Users)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CSADataReport.Model.Users> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CSADataReport.Model.Users> DataTableToList(DataTable dt)
		{
