...
namespace CSADataReport.BLL
{
	...
	{
		private readonly CSADataReport.DAL.IncomeDatas dal=new CSADataReport.DAL.IncomeDatas();
		public IncomeDatas()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CSADataReport.Model.IncomeDatas GetModelByCache(int Id)
		{
			
			string CacheKey = "IncomeDatasModel-" + Id;
			...
			return (CSADataReport.Model.IncomeDatas)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CSADataReport.Model.IncomeDatas> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CSADataReport.Model.IncomeDatas> DataTableToList(DataTable dt)
		{
